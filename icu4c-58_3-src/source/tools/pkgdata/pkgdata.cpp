...
/*!!! This is a hack solely to make binscope happy after the data injection into sbicudt53_xx.dll !!! */
#ifdef _WIN64 
#define LINK_FLAGS "/DLL /NOENTRY /MANIFEST:NO  /base:0x4ad00000 /DYNAMICBASE /DEBUG /PDB:./../../../../../lib64/icudt.pdb /implib:"
#elif _WIN32
#define LINK_FLAGS "/DLL /NOENTRY /MANIFEST:NO  /base:0x4ad00000 /DYNAMICBASE /DEBUG /PDB:./../../../../../lib/icudt.pdb /implib:"
#else
