...
UNICODE_VERSION=9.0
ICU_LIB_TARGET=$(DLL_OUTPUT)\$(SIMBA_ICUDATA_NAME).dll

# SIMBA_ICUDATA_NAME is provided through the project files.
# Assert this variable is supplied via projects
!IF "$(SIMBA_ICUDATA_NAME)"==""
!ERROR Can't find SIMBA_ICUDATA_NAME (name for the icu data dll)!
!ENDIF
